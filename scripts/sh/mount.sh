...
#mount -t nfs maytag.ariba.com:export ~/mnts/maytag            ## /home/rc/archive/builds
#mount -t smbfs //achitale@subzero.ariba.com/abperf ~/mnts/subzero
#mount -t smbfs //achitale@in-blrfs1.ariba.com/Software ~/mnts/in-blrfs1
